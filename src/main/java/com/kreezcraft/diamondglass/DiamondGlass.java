...
public class DiamondGlass {
    ...
    public static class RegistryEvents {
        ...
        public static void onBlockRegistry(final RegistryEvent.Register<Block> event) {
            event.getRegistry().register(new fullBlock("diamond_chiseled_sandstone", Material.ROCK, null));
            ...
            event.getRegistry().register(new slabBlock("diamond_chiseled_sandstone_slab", Material.ROCK, null));
            ...
            event.getRegistry().register(new stairsBlock("diamond_chiseled_sandstone_stairs", Material.ROCK, null));
