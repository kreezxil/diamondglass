...
public class InitBlocks {
	...
	public static final Block DIAMOND_SMOOTH_SANDSTONE = new BlockStandard("diamond_sandstone_smooth");
	public static final Block DIAMOND_CHISELED_SANDSTONE = new BlockStandard("diamond_sandstone_chisel");

	public static final Block DIAMOND_SANDSTONE_STAIRS = new ModStairs("diamond_sandstone_stairs", DIAMOND_SANDSTONE);
	public static final Block DIAMOND_SMOOTH_SANDSTONE_STAIRS = new ModStairs("diamond_sandstone_smooth_stairs", DIAMOND_SANDSTONE);
	public static final Block DIAMOND_CHISELED_SANDSTONE_STAIRS = new ModStairs("diamond_sandstone_chisel_stairs", DIAMOND_SANDSTONE);

	public static final Block DIAMOND_SANDSTONE_SLAB = new ModSlab("diamond_sandstone_slab", DIAMOND_SANDSTONE);
	public static final Block DIAMOND_SMOOTH_SANDSTONE_SLAB = new ModSlab("diamond_sandstone_smooth_slab", DIAMOND_SANDSTONE);
	public static final Block DIAMOND_CHISELED_SANDSTONE_SLAB = new ModSlab("diamond_sandstone_chisel_slab", DIAMOND_SANDSTONE);
